...
AIC.list[2]= AIC(mod2 <- glmmadmb(tot ~ ns(date, df=2) + (1|uniktrans), data=phenuc[phenuc$year==2011,], family="nbinom"))
AIC.list[3]= AIC(mod3 <- glmmadmb(tot ~ ns(date, df=3) + (1|uniktrans), data=phenuc[phenuc$year==2011,], family="nbinom"))
AIC.list[4]= AIC(mod4 <- glmmadmb(tot ~ ns(date, df=4) + (1|uniktrans), data=phenuc[phenuc$year==2011,], family="nbinom"))
AIC.list[5]= AIC(mod5 <- glmmadmb(tot ~ ns(date, df=5) + (1|uniktrans), data=phenuc[phenuc$year==2011,], family="nbinom"))

#2012 - data
AIC.list[7]= AIC(mod6 <- glmmadmb(tot ~ ns(date, df=1) + (1|uniktrans), data=phenuc[phenuc$year==2012,], family="nbinom"))
AIC.list[8]= AIC(mod7 <- glmmadmb(tot ~ ns(date, df=2) + (1|uniktrans), data=phenuc[phenuc$year==2012,], family="nbinom"))
AIC.list[9]= AIC(mod8 <- glmmadmb(tot ~ ns(date, df=3) + (1|uniktrans), data=phenuc[phenuc$year==2012,], family="nbinom"))
AIC.list[10]= AIC(mod9 <- glmmadmb(tot ~ ns(date, df=4) + (1|uniktrans), data=phenuc[phenuc$year==2012,], family="nbinom"))
AIC.list[11]= AIC(mod10 <- glmmadmb(tot ~ ns(date, df=5) + (1|uniktrans), data=phenuc[phenuc$year==2012,], family="nbinom"))
       
## Including elevation. First for year == 2011
## First as additive effect
AIC.list[23]= AIC(mod23 <- glmmadmb(tot ~ ns(date, df=5) + alt.cat + (1|uniktrans), data=phenuc[phenuc$year==2011,], family="nbinom", zeroInflation =T,admb.opts = admbControl(shess = FALSE, noinit = FALSE)))
AIC.list[24]= AIC(mod24 <- glmmadmb(tot ~ ns(date, df=4) + alt.cat + (1|uniktrans), data=phenuc[phenuc$year==2011,], family="nbinom", zeroInflation =T,admb.opts = admbControl(shess = FALSE, noinit = FALSE)))
AIC.list[25]= AIC(mod25 <- glmmadmb(tot ~ ns(date, df=3) + alt.cat + (1|uniktrans), data=phenuc[phenuc$year==2011,], family="nbinom", zeroInflation =T,admb.opts = admbControl(shess = FALSE, noinit = FALSE)))
## Then as interaction
AIC.list[30]= AIC(mod30 <- glmmadmb(tot ~ ns(date, df=5) * alt.cat + (1|uniktrans), data=phenuc[phenuc$year==2011,], family="nbinom", zeroInflation =T,admb.opts = admbControl(shess = FALSE, noinit = FALSE)))
AIC.list[31]= AIC(mod31 <- glmmadmb(tot ~ ns(date, df=4) * alt.cat + (1|uniktrans), data=phenuc[phenuc$year==2011,], family="nbinom", zeroInflation =T,admb.opts = admbControl(shess = FALSE, noinit = FALSE)))
AIC.list[32]= AIC(mod32 <- glmmadmb(tot ~ ns(date, df=3) * alt.cat + (1|uniktrans), data=phenuc[phenuc$year==2011,], family="nbinom", zeroInflation =T,admb.opts = admbControl(shess = FALSE, noinit = FALSE)))

## Including elevation. First for year == 2012
## First as additive effect
AIC.list[37]= AIC(mod37 <- glmmadmb(tot ~ ns(date, df=5) + alt.cat + (1|uniktrans), data=phenuc[phenuc$year==2012,], family="nbinom", zeroInflation =T,admb.opts = admbControl(shess = FALSE, noinit = FALSE)))
AIC.list[38]= AIC(mod38 <- glmmadmb(tot ~ ns(date, df=4) + alt.cat + (1|uniktrans), data=phenuc[phenuc$year==2012,], family="nbinom", zeroInflation =T,admb.opts = admbControl(shess = FALSE, noinit = FALSE)))
AIC.list[39]= AIC(mod39 <- glmmadmb(tot ~ ns(date, df=3) + alt.cat + (1|uniktrans), data=phenuc[phenuc$year==2012,], family="nbinom", zeroInflation =T,admb.opts = admbControl(shess = FALSE, noinit = FALSE)))
## Then as interaction
AIC.list[44]= AIC(mod44 <- glmmadmb(tot ~ ns(date, df=5) * alt.cat + (1|uniktrans), data=phenuc[phenuc$year==2012,], family="nbinom", zeroInflation =T,admb.opts = admbControl(shess = TRUE, noinit = TRUE)))
AIC.list[45]= AIC(mod45 <- glmmadmb(tot ~ ns(date, df=4) * alt.cat + (1|uniktrans), data=phenuc[phenuc$year==2012,], family="nbinom", zeroInflation =T,admb.opts = admbControl(shess = FALSE, noinit = FALSE))) 
AIC.list[46]= AIC(mod46 <- glmmadmb(tot ~ ns(date, df=3) * alt.cat + (1|uniktrans), data=phenuc[phenuc$year==2012,], family="nbinom", admb.opts = admbControl(shess = FALSE, noinit = FALSE)))
